...
base_styles = {
    "QMainWindow": {"font-family": "Segoe UI"},
    "QPushButton": {
        "padding": "8px 15px",
        "border-radius": "4px",
        "font-size": "14px",
    ...
    "#navbar QPushButton[class~='active']": {"border-bottom-color": "#007BFF"},
    "Frame[class~='card']": {
        "border-radius": "6px",
        "border": "1px solid",
    },
    "QLineEdit[class~='valid']": {"border-color": "#28a745"},
    "QLineEdit[class~='invalid']": {"border-color": "#dc3545"},
}
...
light_them = {
    **base_styles,
    ...
    "QLabel": {**base_styles["QLabel"], "color": "#212529"},
    "QLineEdit": {
    ...
    "#navbar": {**base_styles["#navbar"], "border-bottom-color": "#dee2e6"},
    "Frame[class~='card']": {
...
dark_theme = {
    **base_styles,
    ...
    "QLabel": {**base_styles["QLabel"], "color": "#f8f9fa"},
    "QLineEdit": {
        **base_styles["QLineEdit"],
        "border-color": "#495057",
    ...
    "#navbar": {**base_styles["#navbar"], "border-bottom-color": "#343a40"},
    "Frame[class~='card']": {
        **base_styles["Frame[class~='card']"],
        "border-color": "#495057",
        "background-color": "#343a40",
